...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest,
        ...
        LOG.log(Level.getLevel("WORKLEVEL"),
                "JwtAuthenticationTokenFilter got header with content : " + header);
        String login = null;
        ...
        if (header != null && header.startsWith(JwtConstant.TOKEN_PREFIX)) {
            ...
            try {
                ...
                LOG.log(Level.getLevel("WORKLEVEL"),
                        "Login to obtain from token success. login : " + login);
        ...
        if (login != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtTokenUtil.validateToken(authToken, userDetails)) {
                ...
                LOG.log(Level.getLevel("WORKLEVEL"),
                        "authenticated user " + login + ", setting security context");
