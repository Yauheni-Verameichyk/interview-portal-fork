...
public class UserConverter implements Converter<User, UserDTO> {
	...
	private List<UserRoleDiscipline> getUserRoleDisciplines(Map<Role, List<Discipline>> roleDisciplinesMap, User user) {
	...
	private Map<Role, List<Discipline>> getRolesDisciplinesMap(List<UserRoleDiscipline> userRoleDisciplines) {
	...
	private void generatePermissionsByTemplate(PermissionTemplate permissionTemplate,
		...
		for (Map.Entry<Role, List<Discipline>> roleDisciplines : roleDisciplinesMap.entrySet()) {
			generatePermissionsByRoleAndDisciplines(permissionTemplate, roleDisciplines, permissionsSet);
		}
	}
	...
	private String generatePermission(PermissionTemplate permissionTemplate) {
		return permissionTemplate.getName().getName() + "_" + permissionTemplate.getOperation().getName();
	}

	private String generatePermission(PermissionTemplate permissionTemplate, Discipline discipline) {
		return permissionTemplate.getName().getName() + "_" + permissionTemplate.getOperation().getName() + "_"
